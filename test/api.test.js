...
describe('api /movie tests', function () {
    ...
    it('should POST a movie', async function () {
        await request(this.app)
            .post(`/api/v1/movie`)
            .send(movie1)
    ...
    it('should POST a movie FAILED', async function () {
        await request(this.app)
            .post(`/api/v1/movie`)
    ...
    it('should GET a movie in the collection', async function () {
        await request(this.app)
            .get(`/api/v1/movie`)
            .set('Accept', 'application/json')
            .set('Authorization', 'Basic c3Bhcms6dGVzdGluZzE=')
    ...
    it('should DELETE the movie 200', async function () {
        await request(this.app)
    ...
    it('should POST another movie', async function () {
        await request(this.app)
            .post(`/api/v1/movie`)
            .send(movie2)
            .type('application/json')
    ...
    it('should GET two movie in the collection', async function () {
        await request(this.app)
            .get(`/api/v1/movie`)
            .set('Accept', 'application/json')
            .set('Authorization', 'Basic c3Bhcms6dGVzdGluZzE=')
